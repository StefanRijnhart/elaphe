...
class GS1DataMatrix(Barcode):
    """
    >>> bc = GS1DataMatrix()
    >>> bc # doctest: +ELLIPSIS
    <....GS1DataMatrix object at ...>
    ...
    aliases = ('gs1 data matrix', 'gs1-data-matrix', 'gs1_data_matrix')
    class _Renderer(MatrixCodeRenderer):
        ...
        def build_params(self, codestring):
            """
            >>> GS1DataMatrix._Renderer(()).build_params('abcd')
            {'yscale': 1.0, 'codestring': '<61626364>', 'bbox': '0 0 24 24', 'codetype': (), 'xscale': 1.0, 'options': '<>'}
            """
            params = super(GS1DataMatrix._Renderer, self).build_params(codestring)
